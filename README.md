...
Each scorecard card has an **Email scorecard** button at the bottom. Clicking it opens the default mail client (Outlook or equivalent) with a pre-composed email for that engineer. The dashboard tab remains open.
